...
<link rel="stylesheet"
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Permission management <small>Permission list</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Home</a></li>
				<li><a href="${pageContext.request.contextPath}/permission/findAll.do">Permission management</a></li>
			...
			<form action="${pageContext.request.contextPath}/permission/save"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-2 title">Permission name</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="permissionName"
								placeholder="Permission name" value="">
						</div>
						<div class="col-md-2 title">Permission URL</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="url"
								placeholder="url" value="">
						</div>
						<div class="col-md-2 title">Parent permission</div>
						<div class="col-md-4 data">
