...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Permission management <small>All permissions</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Home</a></li>
				<li><a
					href="${pageContext.request.contextPath}/pages/permission-list.jsp">Permission management</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="add" onclick='location.href="${pageContext.request.contextPath}/permission/saveUI"'>
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_desc">Permission name</th>
