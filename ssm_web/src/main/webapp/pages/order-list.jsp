	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/pages/order-list.jsp">Order management</a></li>
						...
						<table id="dataList"
							...
							<thead>
								<tr>
									...
									<th class="sorting">Number of people</th>
									<th class="sorting">Payment option</th>
							...
							<tbody>
								<c:forEach items="${orderList}" var="order">
									<tr>
										...
										<td>${order.payType==0?"paypal":order.payType==1?"zelle":"others"}</td>
										<td>${order.orderStatus == 0 ?"not paid?":"paid"}</td>
										<td>
										...
										<td class="text-center">
											...
											<button type="button" class="btn bg-olive btn-xs"
												onclick='location.href="all-order-manage-edit.html"'>View</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
