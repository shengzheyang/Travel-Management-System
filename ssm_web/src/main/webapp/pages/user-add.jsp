		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/user/save"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							...
							<input type="text" class="form-control" id="username" name="username" onchange="isUniqueUsername(this)"
				...
				<div class="box-tools text-center">
					<button type="submit" id="saveBtn" class="btn bg-maroon">save</button>
