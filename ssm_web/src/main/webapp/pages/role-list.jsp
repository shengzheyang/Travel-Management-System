...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				Role management <small>All roles</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="${pageContext.request.contextPath}/index.jsp"><i
						class="fa fa-dashboard"></i> Home</a></li>
				<li><a
					href="${pageContext.request.contextPath}/role/findAll.do">Role management</a></li>
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="add" onclick="location.href='${pageContext.request.contextPath}/pages/role-add.jsp'">
									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/addPermissionsToRoleUI?roleId=${role.id}" class="btn bg-olive btn-xs">add permission</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
