...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				User management <small>Add role list</small>
			</h1>
			<ol class="breadcrumb">
				...
				<li class="active">Add role list</li>
			</ol>
			</section>
					...
					<table id="dataList"
							...
							<tbody>
								<c:forEach items="${roleList}" var="role">
									<tr>
										<td>
											<input name="ids" type="checkbox" ${fn:contains(str,",".concat(role.id).concat(",") )?"checked":""} value="${role.id}"></td>
										<td>${role.id}</td>
										<td>${role.roleName }</td>
										<td>${role.roleDesc}</td>
