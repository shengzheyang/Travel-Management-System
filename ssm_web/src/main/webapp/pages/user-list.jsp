						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="add" onclick="location.href='${pageContext.request.contextPath}/pages/user-add.jsp'">
								...
								<tbody>
									...
									<c:forEach items="${userList}" var="user" varStatus="i">
										<tr>
											...
											<td>${user.email }</td>
											<td>${user.phoneNum }</td>
											<td>${user.status==1?"open":"close" }</td>
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/details?userId=${user.id}" class="btn bg-olive btn-xs">Details</a>
												<a href="${pageContext.request.contextPath}/user/addRoleToUserUI?userId=${user.id}" class="btn bg-olive btn-xs">Add role</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
